...
if (length(arquivos)==0){
  ...
  tabela_texto<<- tibble(datahora= Sys.time(), texto= "Olá traga sua contribuição anônima. Basta escrever.")
...
actionButton(inputId = "btn_atualiza_conversas",  "Atualiza as conversas", value= FALSE)
...
actionButton(inputId = "btn_salva_contribuicao",  "Salva contribuição", value= FALSE)
