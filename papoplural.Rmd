...
if (length(arquivos)==0){
  ...
  tabela_texto<<- tibble(datahora= Sys.time(), Comentários= "Olá! Esse é o Papo Plural, um canal onde pessoas associadas da Abraji podem deixar seus comentários para a Chapa Plural sobre o que querem para a associação. Escreva na coluna à esquerda e clique em 'Salvar' para registrar seu comentário! Não precisa se identificar. Agradecemos pela participação! Um abraço, CHAPA PLURAL: POR UMA ABRAJI FORTE E COLETIVA")
...
source_data <-iris  #tibble(texto="Faça um duplo clique e digite aqui sua contribuição")
...
observeEvent(input$btn_salva_contribuicao,{
 ...
 bind_rows(
   tibble(datahora= Sys.time(), Comentários= input$texto)
 ) %>%
